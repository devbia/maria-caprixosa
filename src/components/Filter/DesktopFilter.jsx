...
import { Services, Periodo, LocationCity, Comodos, Location } from "./DesktopTab";
    ...
    <div className="mx-14 hidden lg:flex rounded py-4 bg-[#f0ecf1]  w-full px-4">
            <div className="flex relative w-full">
              ...
              <div className="flex flex-col justify-center">
                <button onClick={() => window.location.href = "/profiles"} className="btn btn-primary w-40 btn-sm">buscar</button>
              </div>
            </div>
          </div>
  );
