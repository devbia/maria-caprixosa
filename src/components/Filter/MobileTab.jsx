...
import SubFilterMobile from "./SubFilterMobile";
...
export const Services = ({ beforeItem, id = "services" }) => {
  ...
  return (
    <TabTemplateMobile
      ...
      subtitle={
        "Descrição dos serviços realizados nessa categoria selecionada."
      }
    >
    ...
    return (
      <div className="flex justify-between w-full">
        <div
          ...
          className={`flex flex-col w-full gap-3  rounded-lg p-3 hover:bg-[#d3c5d6] ${
            selected && "bg-[#d3c5d6]"
          }`}
        >
        ...
        >
          <div className="grid grid-cols-1 gap-5">
            <div className="flex justify-between mt-3">
              {blockTime("Manhã", "07:00", "13:00", horaDoDia == "manha", () =>
                setHoraDoDia("manha")
              )}
              {blockTime("Tarde", "13:00", "18:00", horaDoDia == "tarde", () =>
                setHoraDoDia("tarde")
              )}
            </div>
            <div
...
export const Comodos = ({ beforeItem, id = "comodos" }) => {
  ...
  return (
    <TabTemplateMobile
      ...
      id={"comodos"}
      beforeItem={beforeItem}
      subtitle={"Quantos comodos?"}
    >
      <div className="w-full  flex-col md:flex-row h-full flex pt-3 max-h-full md:max-h-full overflow-auto">
    ...
    >
      <div className="flex flex-col md:w-full justify-between py-8">
        <div className="form-control w-full max-w-xs">
          ...
          {invalidCEP && (
            <small className="text-red-500 mt-3">CEP não encontrado</small>
          )}
        </div>
