  ...
  function blockTime(title, start = "", end = "", selected = false, selecionarItem) {
    ...
    return (
      <div className="flex justify-between w-full">
        <div onClick={selecionarItem} className={`flex flex-col w-full gap-3 w-1/2 rounded-lg p-3 hover:bg-[#d3c5d6] ${selected && "bg-[#d3c5d6]"}`}>
     ...
     <TabTemplate title={"Periodos"} id={"periodos"} subtitle={"Quantos dias na semana?"}>
      ...
      <div className="flex flex-col self-end w-full">
        <div className="flex relative">
           <SubFilter isOpen={showTimes} close={closeSubMenu} title="Os horários">
     ...
     <TabTemplate title={"Localização"} id={"location"} subtitle={"Qual local para presta o serviço?"}>
      <div className="flex justify-between py-8">
          <div className="form-control w-full max-w-xs">
            ...
            {invalidCEP && <small className="text-red-500">CEP não encontrado</small>}
          </div>
