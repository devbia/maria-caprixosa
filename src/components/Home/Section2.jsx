      ...
      <div id="filterBTN" className="flex flex-col">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8 mb-10 md:mb-14">
            <CheckBox
              name="category"
              checked={choosedOption == "faxineira"}
              onClick={(_) => toggleCheckBox("faxineira")}
              label={"faxineira"}
              checkboxClass="checkbox-primary"
              labelClass="uppercase font-bold"
            />
            <CheckBox
              name="category"
              checked={choosedOption == "diarista"}
              onClick={(_) => toggleCheckBox("diarista")}
              label={"diarista"}
              checkboxClass="checkbox-primary"
              labelClass="uppercase font-bold"
            />
            <CheckBox
              name="category"
              checked={choosedOption == "domestica"}
              onClick={(_) => toggleCheckBox("domestica")}
              label={"doméstica"}
              checkboxClass="checkbox-primary"
              labelClass="uppercase font-bold"
            />
        ...
        <div className="flex w-full">
          ...
          <button
            ...
            className="btn btn-info w-full lg:hidden gap-5"
          >
            <FiFilter size={35} />
            Filtre sua busca
          </button>
      ...
      <div className="py-10 md:py-28 mx-14 ">
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="flex flex-col gap-8 h-full justify-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <p>
                  A Maria caprixosa é uma plataforma que conecta clientes
                  contratantes a prestadoras de serviço de limpeza autônomas e
          ...
          <div className="hidden md:flex justify-end">
            <img
              src="/images/home/aspirador.png"
              className="max-w-[230px] lg:max-w-sm rounded-lg"
              alt="Por que maria caprixosa?"
            />
          </div>
        </div>
