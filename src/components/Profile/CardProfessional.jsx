      ...
      stars.push(
        <input
          ...
          className={`mask mask-star-2 ${
            index < starts ? "bg-purple-500" : "bg-gray-400"
          }`}
          disabled
        />
      );
    ...
    <div className="flex w-full justify-center mx-4">
      <div className="card w-72 bg-transparent">
        <figure>
          <img
            src={image}
            alt={"Maria caprixosa - " + name + " trabalha com " + job}
          />
        </figure>
                ...
                <div className="flex flex-col h-full justify-center align-middle gap-2">
                  <div className="flex self-end gap-2">
                    ...
                    {loveProfessional ? (
                      <MdOutlineFavorite
                        onClick={(_) => love()}
                        className="lg:text-[25px] text-red-700 cursor-pointer"
                      />
                    ) : (
                      <MdOutlineFavoriteBorder
                        onClick={(_) => love()}
                        className="lg:text-[25px] text-gray-700 cursor-pointer"
                      />
                    )}
                  </div>
                </div>
