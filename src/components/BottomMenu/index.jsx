  ...
  return (
    <div ref={heightBottom} className="fixed bottom-0 w-full bg-white py-3 md:hidden z-20">
      ...
      <div className="grid grid-cols-3">
        <div onClick={_ => toggleChangeView("filter")} className={`flex flex-col text-center justify-center ${filterMobileOpen && "text-purple-500"}`}>
        ...
        <div onClick={_ => toggleChangeView("contact")} className={`flex flex-col text-center justify-center ${tabOpen == "contact" && 'text-purple-500'}`}>
